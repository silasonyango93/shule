...
module.exports = class BedAllocationInformationTypesController{
   ...
   static get_specific_records(ColumnName,value_){
	   return new Promise(function(resolve, reject) {  
        ...
        var myPromise = BedAllocationInformationTypesModel.get_specific_records(ColumnName,value_);
   ...
   static batch_update(jsonObject_){
	   return new Promise(function(resolve, reject) {  
		...
		var myPromise = BedAllocationInformationTypesModel.batch_update(jsonObject_);
   ...
   static individual_record_update(ColumnName,value_,jsonObject_){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = BedAllocationInformationTypesModel.individual_record_update(ColumnName,value_,jsonObject_);
   ...
   static delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = BedAllocationInformationTypesModel.delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId);
   ...
   static get_number_of_records(ColumnName,value_){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = BedAllocationInformationTypesModel.get_number_of_records(ColumnName,value_);
	...
	static user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = BedAllocationInformationTypesModel.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
