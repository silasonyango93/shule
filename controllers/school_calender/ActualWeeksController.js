...
module.exports = class ActualWeeksController{
   ...
   static individual_record_update(ColumnName,value_,jsonObject_){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = ActualWeeksModel.individual_record_update(ColumnName,value_,jsonObject_);
   ...
   static delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = ActualWeeksModel.delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId);
   ...
   static get_number_of_records(ColumnName,value_){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = ActualWeeksModel.get_number_of_records(ColumnName,value_);
	...
	static user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = ActualWeeksModel.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
